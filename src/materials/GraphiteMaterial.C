...
#include "GraphiteMaterial.h"

registerMooseObject("PandaApp", GraphiteMaterial);
...
GraphiteMaterial::GraphiteMaterial(const InputParameters & parameters) :
    Material(parameters),
...
void
GraphiteMaterial::computeQpProperties()
{
